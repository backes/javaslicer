 ...
 *    Class:     UncompressedTraceSequenceFactory
 *    Filename:  javaslicer-tracer/src/main/java/de/unisb/cs/st/javaslicer/tracer/traceSequences/uncompressed/UncompressedTraceSequenceFactory.java
 *
...
public class UncompressedTraceSequenceFactory implements TraceSequenceFactory, TraceSequenceFactory.PerThread {
    ...
    public void writeOut(final OutputStream out) throws IOException {
        out.write(TraceSequenceTypes.FORMAT_UNCOMPRESSED);
    }
