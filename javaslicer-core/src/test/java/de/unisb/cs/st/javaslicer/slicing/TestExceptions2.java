...
public class TestExceptions2 extends AbstractSlicingTest {
    ...
    public void test25all() throws IllegalArgumentException, IOException, URISyntaxException, InterruptedException {
        ...
        checkSlice(slice, new String[] {
                "de.unisb.cs.st.javaslicer.tracedCode.Exceptions2.main:20 ACONST_NULL",
                "de.unisb.cs.st.javaslicer.tracedCode.Exceptions2.main:20 ASTORE 2",
                "de.unisb.cs.st.javaslicer.tracedCode.Exceptions2.main:24 ALOAD 2",
                "de.unisb.cs.st.javaslicer.tracedCode.Exceptions2.main:24 INVOKESTATIC de/unisb/cs/st/javaslicer/tracedCode/Exceptions2.useArrays([I[I)I",
                "de.unisb.cs.st.javaslicer.tracedCode.Exceptions2.main:25 ASTORE 4",
                "de.unisb.cs.st.javaslicer.tracedCode.Exceptions2.useArrays:46 ALOAD 1",
                "de.unisb.cs.st.javaslicer.tracedCode.Exceptions2.useArrays:46 IFNONNULL L1",
                "de.unisb.cs.st.javaslicer.tracedCode.Exceptions2.useArrays:47 NEW java/lang/NullPointerException",
                "de.unisb.cs.st.javaslicer.tracedCode.Exceptions2.useArrays:47 ATHROW",
            });
    }
