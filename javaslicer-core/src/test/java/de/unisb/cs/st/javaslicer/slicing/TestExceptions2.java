...
public class TestExceptions2 extends AbstractSlicingTest {
    ...
    public void test46all() throws IllegalArgumentException, IOException, URISyntaxException, InterruptedException {
        final List<Instruction> slice = getSlice("/traces/exceptions2", "main", "de.unisb.cs.st.javaslicer.tracedCode.Exceptions2.main:46:*");
        checkSlice(slice, new String[] {
    ...
    @Test
    public void test36a() throws IllegalArgumentException, IOException, URISyntaxException, InterruptedException {
        final List<Instruction> slice = getSlice("/traces/exceptions2", "main", "de.unisb.cs.st.javaslicer.tracedCode.Exceptions2.main:49:{a}");
        checkSlice(slice, new String[] {
                "de.unisb.cs.st.javaslicer.tracedCode.Exceptions2.main:39 ACONST_NULL",
                "de.unisb.cs.st.javaslicer.tracedCode.Exceptions2.main:39 ASTORE 1",
                "de.unisb.cs.st.javaslicer.tracedCode.Exceptions2.main:41 ALOAD 1",
