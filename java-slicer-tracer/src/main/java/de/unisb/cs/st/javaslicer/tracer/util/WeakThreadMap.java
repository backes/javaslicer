...
public class WeakThreadMap<V> implements Map<Thread, V> {
     ...
     */
    void createEntry(final int hash, final Thread key, final V value, final int bucketIndex) {
        final Entry<V> e = this.table[bucketIndex];
        this.table[bucketIndex] = new Entry<V>(key, value, e, this.queue);
        this.size++;
    }
        ...
        return new AbstractSet<Thread>() {
            ...
            public Iterator<Thread> iterator() {
                return new Iterator<Thread>() {
                    private final Iterator<Map.Entry<Thread, V>> i = entrySet().iterator();
        ...
        return new AbstractCollection<V>() {
            ...
            public Iterator<V> iterator() {
                return new Iterator<V>() {
                    private final Iterator<Map.Entry<Thread, V>> i = new EntryIterator();
    ...
    // TODO replace AbstractSet (would otherwise be traced)
    final class EntrySet extends AbstractSet<Map.Entry<Thread, V>> {
        @Override
